(function (factory) {
    ...
    try {
        ...
        // //my phone masking
        // $('#contact_phone').mask('(999) 999-9999', {placeholder:'x'});
            ...
            submitHandler:function() {
                $( '#j-forms' ).ajaxSubmit({
                    ...
                    success:function(){
                        ...
                        // let host_my = location.origin + "/bids/bids/";
                        // console.log(host_my);
                        window.open('/bids/bids/','_self');
                        // $.get(host_my);
        ...
        if($.fn.autoNumeric){
            ...
            $('#radio-select-currency').change(function(){
                ...
                if ( value == 'euro') {
                    $('#input-select-currency').autoNumeric('update', {aSign: 'в‚¬ '});
                }
                if ( value == 'pound') {
                    $('#input-select-currency').autoNumeric('update', {aSign: 'ВЈ '});
                }
                if ( value == 'yen') {
                    $('#input-select-currency').autoNumeric('update', {aSign: 'ВҐ '});
                }
            }).change();
            /***************************************/
